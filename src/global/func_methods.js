...
const func_methods = {
  ...
  feb29Between: function(date1, date2){
    ...
    const mar1year1 = dayjs().set({ 'year': year1, 'month': 2, 'date': 1 });
    ...
    const mar1year2 = dayjs().set({ 'year': year2, 'month': 2, 'date': 1 });
