...
import {chatatABC, getObjType, luckysheetContainerFocus, numFormat,} from '../utils/util';
...
export function initialMatrixOperation(){
  ...
  $('#luckysheet-copy-json-head').click(function (event) {
    ...
    const getdata = getdatabyselection(Store.luckysheet_select_save[0]);
    const arr = [];
    if (getdata.length == 0) {
      return;
    }
  ...
  $('#luckysheet-copy-json-nohead').click(function (event) {
    ...
    const st = Store.luckysheet_select_save[0]['column'][0];
  ...
  $('#luckysheet-matrix-delezero-row').click(function (event) {
    ...
    const arr = [];
    const getdatalen = getdata[0].length;
    for (let r = 0; r < getdata.length; r++) {
  ...
  $('#luckysheet-matrix-delezero-column').click(function (event) {
    ...
    const arr = [];
    const getdatalen = getdata.length, collen = getdata[0].length;
