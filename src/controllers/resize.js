...
export default function luckysheetsizeauto(isRefreshCanvas=true) {
  ...
  if(ismore){
    ...
    $('#luckysheet-icon-morebtn').click(function(){
      ...
      const right = $(window).width() - $('#luckysheet-icon-morebtn').offset().left - $('#luckysheet-icon-morebtn').width()+ $('body').scrollLeft();
      ...
      const $txt = $(this).find('.luckysheet-toolbar-menu-button-caption');
