  ...
  $('#luckysheetorderby').click(function () {
    ...
    if (luckysheet_sort_initial) {
      ...
      $('#luckysheet-sort-dialog .luckysheet-sort-dialog-additem').click(function () {
        ...
        const t = $('#luckysheet-sort-haveheader').is(':checked');
    ...
    const $t = $('#luckysheet-sort-dialog'), myh = $t.outerHeight(), myw = $t.outerWidth();
    ...
    if (r1 < r2) {
      setTimeout(function () {
        ...
        for (let i = c1; i <= c2; i++) {
          const isdatatype_r1 = isdatatype(flowrowdata1[i]),
